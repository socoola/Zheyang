...
static struct statement global_statements[] = {
    ...
    { "contry", config_wifi_country, 1, 1, { TOKEN_NUM } },
    { "droprate", config_droprate, 1, 1, { TOKEN_NUM } },
    { "signalquality", config_wifi_signal_quality, 1, 1, { TOKEN_NUM } },
    { "signaldiff", config_wifi_signal_diff, 1, 1, { TOKEN_NUM } },
    { "ssid", config_wifi_ssid, 1, 1, { TOKEN_STR } },
    { "address", config_wifi_address, 1, 1, { TOKEN_STR } },
#if 0
